...
public class Tab_Ranking_Weekly_Global extends Activity{
    private static final String TAG = MainActivity.class.getSimpleName();
    private static final String url = AppConfig.URL_SHOW_RANKING_WEEKLY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ranking_weekly_global);
